import { Activity, CalendarCheck, Lock, SlidersChart } from "./icons";

const FEATURES = [
  {
    icon: Activity,
    title: "Real-time Monitoring",
    desc: "Live insights into activity, apps, and productivity.",
  },
  {
    icon: SlidersChart,
    title: "Smart Analytics",
    desc: "Data-driven reports to optimize team performance.",
  },
  {
    icon: CalendarCheck,
    title: "Automatic Time Tracking",
    desc: "Accurate time logs with idle time detection.",
  },
  {
    icon: Lock,
    title: "Privacy First",
    desc: "Secure, GDPR-compliant, and built on trust.",
  },
];
        ...
        {FEATURES.map((f) => (
          <div key={f.title} className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-[13.5px] leading-snug text-gray-500">
                {f.desc}
              </p>
            </div>
          </div>
